(function (soma) {
	...
	Node.prototype = {
		...
		render: function() {
			console.log('ELEMENT - SCOPE', this.element, this.scope);
			console.log('IS TEMPLATE', childNodeIsTemplate(this));
			console.log('HASH', this.element.somaTpl, this.element.somaHashkey);
			if (childNodeIsTemplate(this)) {
				return;
			}
	...
	var templates = new HashMap('somaTpl');

	var Template = function(element) {
		this.watchers = new HashMap('somaTplWatch');
		this.node = null;
		this.scope = null;
