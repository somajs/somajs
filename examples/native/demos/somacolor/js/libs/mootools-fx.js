...
web build:
 - http://mootools.net/core/734f3904857db4068de25888bdf412ac

packager build:
 - packager build Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions
...
n[m]={};n.borderWidth[l]=n[m][l]=j[l]="@px";n.borderStyle[i]=n[m][i]=j[i]="@";n.borderColor[k]=n[m][k]=j[k]="rgb(@, @, @)";});})();Fx.CSS=new Class({Extends:Fx,prepare:function(c,d,b){b=Array.from(b);
