...
YUITest.PageManager = YUITest.Util.mix(new YUITest.EventTarget(), {
    ...
    /**
     * The frame used to load and run unittests.
     * @type Window
     * @private
     * @property _frame
     * @static
    ...
    /**
     * The timeout ID for the next iteration through the unittests.
     * @type int
     * @private
     * @property _timeoutId
     * @static
    ...
    /**
     * Begins the process of running the unittests.
     * @return {Void}
     * @method start
     * @static
     */
    start : function () /*:Void*/ {
        ...
        this._results = {
            ...
            pages_failed: 0,
            // total number of unittests passed
            tests_passed: 0,
            // total number of unittests failed
            tests_failed: 0,
    ...
    /**
     * Stops the execution of unittests.
     * @return {Void}
     * @method stop
     * @static
     */
