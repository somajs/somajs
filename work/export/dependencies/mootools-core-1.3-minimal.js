...
web build:
 - http://mootools.net/core/630d1121054d6617aeb7cbc78cb1c88d

packager build:
 - packager build Core/Core Core/Class Core/Element Core/Element.Event Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions
...
for(var i in h){f.call(this,i,h[i],true);}},this);}};})();(function(){var k=this.document;var i=k.window=this;var b=1;this.$uid=(i.ActiveXObject)?function(e){return(e.uid||(e.uid=[b++]))[0];
