...
({
	...
	{
		//pyroma.core.EventProxy.send( CommandEventList.CHAIN_CHAIN );
		this.fireEvent( CommandEventList.CHAIN_CHAIN );
	},
	
	asyncListener: function()
	{
		//pyroma.core.EventProxy.send( CommandEventList.ASYNC_CALL );
	...
	{
		 //pyroma.core.EventProxy.send( CommandEventList.SEQUENCE_STOP_ALL )
